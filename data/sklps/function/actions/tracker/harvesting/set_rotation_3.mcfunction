...
# -------------------------------------------------------------------------------------------
execute store result entity @s Rotation[0] float 1 run scoreboard players add #player_yaw sklps.harvesting.temp 5
execute store result entity @s Rotation[1] float 1 run scoreboard players remove #player_pitch sklps.harvesting.temp 1